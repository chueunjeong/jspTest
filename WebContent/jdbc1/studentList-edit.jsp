...
<div class="container">
<h1>학생목록</h1>
<a id="createButton" class="btn btn-primary" href="create-studentList.jsp">
...
<table class="table table-bordered table-condensed">
    ...
    <tbody>
        <% for (Student student : list) { %>
            <tr data-url="edit-studentList.jsp?id=<%= student.getId() %>&pg=<%= currentPage %>">
                <td><%= student.getId() %></td>
