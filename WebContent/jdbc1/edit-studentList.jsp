...
//get 방식이면 해당 쿼리스트링에 해당하는 아이디 학생 찾아서 저장
else { //변경된 내용이 생기는 경우
    student = new Student();
    student.setId(id);
    ...
    if (s1 == null || s1.length() == 0) 
        ...
        response.sendRedirect("studentList-edit.jsp?pg="+pg);
        return;
    }
}
%>
...
<form method="post">
  ...
  <button type="submit" class="btn btn-primary" onclick="return confirm('저장하시겠습니까?')">
